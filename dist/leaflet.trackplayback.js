      ...
      const a = n.a.Class.extend({
          ...
          _getCalculateTrackPointByTime: function (t) {
            ...
            let c = r[o],
              l = r[h],
              u = t,
              _ = this.getTrackPointByTime(c),
              p = this.getTrackPointByTime(l);
            (e = n.a.point(_.lng, _.lat)), (s = n.a.point(p.lng, p.lat));
            ...
            return (
              i
                ...
                : (i = { lng: g, lat: P, dir: y, isOrigin: !1, time: t }),
              i
            );
          },
        ...
        l = n.a.Class.extend({
          ...
          _opentoolTip: function (t) {
            ...
            e.setLatLng(i), e.addTo(this._map), e.setContent(`${i}`);
          },
